...
const ModalSizeChart = (props, ref) => {
    ...
    return createPortal(
        <>
            <div
                className={`${isOpen ? 'show' : ''} modal fade`}
                style={isOpen ? styleModal : null}
                id="modalSizeChart"
                tabIndex={-1}
                role="dialog"
                aria-hidden="true"
            ...
            {isOpen && (
                <div onClick={close} className="modal-backdrop fade show"></div>
            )}
        </>,
...
export default forwardRef(ModalSizeChart);
